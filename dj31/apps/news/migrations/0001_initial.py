# Generated by Django 2.1.7 on 2021-05-31 06:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='banner',
            name='news',
            field=models.OneToOneField(choices=[(1, '第一级'), (2, '第二级'), (3, '第三级'), (4, '第四级'), (5, '第五级'), (6, '第六级')], default=6, on_delete=django.db.models.deletion.CASCADE, to='news.News'),
        ),
    ]
