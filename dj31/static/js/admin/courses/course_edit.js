$(function () {
  ...
  $upload_image_server.change(function () {
    ...
    oFormData.append("image_files", file); // 把文件添加进去
    // 发送请求
    $.ajax({
  ...
  credentials: {
    ak: 'bb55c1cc999b4f43bca5fc63fc76c8ee',	 // 填写你的百度云中ak和sk
    sk: 'c0dfbeee391349498855f3dc76ddda5e'    // 在百度vod 安全认证里面
  }
  };
      // 百度云vod域名在多媒体/全局设置/发布设置里面
  let BAIDU_VOD_DOMAIN = 'jenky9h30kf84g6as4n.exp.bcevod.com';	// 百度云VOD域名
  ...
  $docsBtn.click(function () {
    ...
    // 判断视频时长是否为空
    let sCourseTime = $('#docs-file-url').val();  // 获取视频时长
    console.log(sCourseTime)
    if (!sCourseTime) {
